...
function Admin() {
 ...
 <Link to='Admin/css/all.min.css' rel="stylesheet" type="text/css"/> 
    <Link
        to="https://fonts.googleapis.com/css?family=Nunito:200,200i,300,300i,400,400i,600,600i,700,700i,800,800i,900,900i"
        rel="stylesheet"/> 

    {/* {/* Custom styles for this template */} 
    <Link to="Admin/css/sb-admin-2.min.css" rel="stylesheet"/>
...
{/* <body id="page-top"> */}
    ...
    {/* {/* Page Wrapper   */}
    <div className='hello' id="wrapper">
        ...
        <ul className="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li className="nav-item">
                <a className="nav-Link collapsed" to="#" data-toggle="collapse" data-target="#collapseUtilities"
                ...
                <div id="collapseUtilities" className="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div className="bg-white py-2 collapse-inner rounded">
                        ...
                        <a className="collapse-item" to="utilities-color.html">Colors</a>
                        <a className="collapse-item" to="utilities-border.html">Borders</a>
                        <a className="collapse-item" to="utilities-animation.html">Animations</a>
                        <a className="collapse-item" to="utilities-other.html">Other</a>
                    </div>
                </div>
            </li>
            ...
            {/* <div className="sidebar-card d-none d-lg-flex">
                ...
                <a className="btn btn-success btn-sm" to="https://startbootstrap.com/theme/sb-admin-pro">Upgrade to Pro!</a>
            </div> */}
            ...
            <div id="content">
                ...
                <div className="container-fluid">
                    ...
                    <div className="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a to="#" className="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                            ...
                            <div className="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <div className="dropdown no-arrow">
                                        <a className="dropdown-toggle" to="#" role="button" id="dropdownMenuLink"
                                            data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            <div className="card shadow mb-4">
                                ...
                                <div className="card-body">
                                    ...
                                    <p>Add some quality, svg illustrations to your project courtesy of <a
                                            target="_blank" rel="nofollow" to="https://undraw.co/">unDraw</a>, a
                                        constantly updated collection of beautiful svg images that you can use
                                        completely free and without attribution!</p>
                                    <a target="_blank" rel="nofollow" to="https://undraw.co/">Browse Illustrations on
                                        unDraw &rarr;</a>
                                </div>
                            </div>
    ...
    <a className="scroll-to-top rounded" to="#page-top">
        ...
        <div className="modal-dialog" role="document">
            <div className="modal-content">
                ...
                <div className="modal-footer">
                    ...
                    <a className="btn btn-primary" to="login.html">Logout</a>
                </div>
            </div>
        </div>
    </div>
